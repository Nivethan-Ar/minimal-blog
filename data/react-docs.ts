  ...
  body: [
    ...
    },
    {
      ...
      paragraphs: [
        {
          __html:
            'qqqIn order to debug a React App you can install the React Developer Tools browser extension which is available on Chrome, Firebox & Edge. if you use any chromium based browsers like Brave or Vivaldi it will also work fine. for debug on Safari you need to install react-devtools npm package globally',
        },
      ],
    },
  ],
...
export const reactBlogData: Data[] = [installation, quick, quick];
